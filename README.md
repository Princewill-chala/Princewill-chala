...
- **Cloud Computing -> AWS** : Design, deploy, manage scalable and secure infastructures in the cloud.
- **Cybersecurity & Networking** : Understand, secure, test systems and networks from both a defensive and offensive perspective.
- **Data Analytics** : Extract, clean, analyze, and visualize data for insights that drive smarter decision-making.
- **Web Development** : Build responsive, user-friendly, and interactive web applications.
